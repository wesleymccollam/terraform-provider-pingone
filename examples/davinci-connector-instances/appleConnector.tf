resource "pingone_davinci_connector_instance" "appleConnector" {
  ...
  properties = jsonencode({
    "authType" = var.appleconnector_property_auth_type
    "button" = var.appleconnector_property_button
    ...
    "showPoweredBy" = var.appleconnector_property_show_powered_by
    "skipButtonPress" = var.appleconnector_property_skip_button_press
  })
}
