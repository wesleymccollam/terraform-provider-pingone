resource "pingone_davinci_connector_instance" "connectorAmazonDynamoDB" {
  ...
  properties = jsonencode({
    ...
    "itemsJSON" = var.connectoramazondynamodb_property_items_json
    "itemsKV" = var.connectoramazondynamodb_property_items_kv
    "keyConditionExpression" = var.connectoramazondynamodb_property_key_condition_expression
    "keyJSON" = var.connectoramazondynamodb_property_key_json
    "keyKV" = var.connectoramazondynamodb_property_key_kv
