resource "pingone_davinci_connector_instance" "connectorHubspot" {
  ...
  properties = jsonencode({
    ...
    "contactID" = var.connectorhubspot_property_contact_id
    ...
    "hubspotOwnerID" = var.connectorhubspot_property_hubspot_owner_id
    ...
    "ticketID" = var.connectorhubspot_property_ticket_id
    ...
    "toObjectID" = var.connectorhubspot_property_to_object_id
