resource "pingone_davinci_connector_instance" "connectorSalesforceMarketingCloud" {
  ...
  properties = jsonencode({
    ...
    "contentURL" = var.connectorsalesforcemarketingcloud_property_content_u_r_l
    ...
    "objectIDorKey" = var.connectorsalesforcemarketingcloud_property_object_i_dor_key
    "options" = var.connectorsalesforcemarketingcloud_property_options
    "optionsASYNCandSYNC" = var.connectorsalesforcemarketingcloud_property_options_a_s_y_n_cand_s_y_n_c
