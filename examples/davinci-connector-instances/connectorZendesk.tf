resource "pingone_davinci_connector_instance" "connectorZendesk" {
  ...
  properties = jsonencode({
    ...
    "organizationID" = var.connectorzendesk_property_organization_i_d
    "organizationMembershipID" = var.connectorzendesk_property_organization_membership_i_d
    ...
    "ticketFormID" = var.connectorzendesk_property_ticket_form_i_d
    "ticketID" = var.connectorzendesk_property_ticket_i_d
    ...
    "userID" = var.connectorzendesk_property_user_i_d
