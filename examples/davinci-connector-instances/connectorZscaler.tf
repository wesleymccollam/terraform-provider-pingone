resource "pingone_davinci_connector_instance" "connectorZscaler" {
  ...
  properties = jsonencode({
    ...
    "departmentID" = var.connectorzscaler_property_department_i_d
    "departmentIDPID" = var.connectorzscaler_property_department_i_d_p_i_d
    ...
    "groupsID" = var.connectorzscaler_property_groups_i_d
    "groupsIDPID" = var.connectorzscaler_property_groups_i_d_p_i_d
    ...
    "userID" = var.connectorzscaler_property_user_i_d
