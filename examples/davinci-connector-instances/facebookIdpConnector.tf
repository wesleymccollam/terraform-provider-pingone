resource "pingone_davinci_connector_instance" "facebookIdpConnector" {
  ...
  properties = jsonencode({
    "authType" = var.facebookidpconnector_property_auth_type
    "button" = var.facebookidpconnector_property_button
    "oauth2" = jsonencode({
				"properties": {
				  "providerName": {
					"type": "string",
    ...
    "showPoweredBy" = var.facebookidpconnector_property_show_powered_by
    "skipButtonPress" = var.facebookidpconnector_property_skip_button_press
  })
}
