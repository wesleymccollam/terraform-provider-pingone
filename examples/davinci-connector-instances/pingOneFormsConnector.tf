resource "pingone_davinci_connector_instance" "pingOneFormsConnector" {
  ...
  properties = jsonencode({
    ...
    "isIAFDetectionEnabled" = var.pingoneformsconnector_property_is_i_a_f_detection_enabled
    ...
    "linkMFAPolicies" = var.pingoneformsconnector_property_link_m_f_a_policies
