resource "pingone_davinci_connector_instance" "skOpenIdConnector" {
  ...
  properties = jsonencode({
    ...
    "publicKeyJWTEndpointURL" = var.skopenidconnector_property_public_key_jwtendpoint_url
    "publicKeyPEMContents" = var.skopenidconnector_property_public_key_pemcontents
